...
public class AlbumTwoPlaySongActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent homeIntent = new Intent(AlbumTwoPlaySongActivity.this, LibraryActivity.class); //This allows user login to go back to library after pressing ont he back button
    ...
    public void playNext(View view) {
        Song nextSong = albumTwoCollectionActivity.getNextSong(songId);
    ...
    public void playPrevious(View view) {
        Song prevSong =albumTwoCollectionActivity.getPreviousSong(songId);
        if (prevSong != null) {
    ...
    public void playShuffle(View view) {
        Song shuffleSong = albumTwoCollectionActivity.getShuffleSong(songId);
        if (shuffleSong != null) {
