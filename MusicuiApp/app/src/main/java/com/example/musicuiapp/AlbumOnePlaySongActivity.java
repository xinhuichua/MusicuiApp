...
public class AlbumOnePlaySongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_album_one_play_song);
            ...
            public void onClick(View view) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent homeIntent = new Intent(AlbumOnePlaySongActivity.this, LibraryActivity.class); //This allows user login to go back to library after pressing ont he back button
    ...
    public void playNext(View view) {
        Song nextSong = albumOneCollectionActivity.getNextSong(songId);
    ...
    public void playPrevious(View view) {
        Song prevSong = albumOneCollectionActivity.getPreviousSong(songId);
        if (prevSong != null) {
    ...
    public void playShuffle(View view) {
        Song shuffleSong = albumOneCollectionActivity.getShuffleSong(songId);
        if (shuffleSong != null) {
    ...
    public void playLoop(View view) {
        ...
        flag = !flag; //if user disables the loop , the song will not repeat again
